...
let titleCreate = d.querySelector(".title-create");
let titleUpdate = d.querySelector(".title-update");
let btncrerpro = d.querySelector(".btn-crer-pro");
...
btncrerpro.addEventListener('click', () =>
...
d.addEventListener("DOMContentLoaded", ()=>{ 
    ...
    if(productUpdate != null){
        updateDataProduct();
        titleUpdate.classList.toggle("d-none");
    }
});
...
let updateDataProduct = ()=>{debugger
    ...
    titleCreate.classList.toggle("d-none");  
